...
# blood flow from vessel to tissue only in hepatic artery
...
def setup_problem(i, f, eps=None):
    ...
    radius = 2.02E-2 # Averaging radius for cyl. surface
    quadrature_degree = 10  # Quadrature degree for that integration
    ...
    # 1D bc for pressure gradient inn 1D
...
if __name__ == '__main__':
    ...
    # print(uh3d.compute_vertex_values()[4768])
    # print(uh1d.compute_vertex_values()[0])